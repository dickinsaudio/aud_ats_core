...
const char *       ATS_CORE_GIT_HASH_FULL                   = "f22f4e6354711bd7d2889f178d79bbf63304a7cc";
const char *       ATS_CORE_GIT_HASH_SHORT                  = "f22f4e63";
const bool         ATS_CORE_GIT_STATE_CHANGES               = 1 ? true : false;
const char *       ATS_CORE_GIT_COMPONENT_TAG_HASH          = "UNKNOWN";
const char *       ATS_CORE_GIT_COMPONENT_TAG_HASH_SHORT    = "UNKNOWN";
const char *       ATS_CORE_GIT_COMPONENT_TAG               = "";
const char *       ATS_CORE_GIT_COMPONENT_TAG_VERSION       = "UNKNOWN";
const bool         ATS_CORE_GIT_COMMITS_SINCE_COMPONENT_TAG = 999 ? true : false;
const char *       ATS_CORE_GIT_COMPONENT_TAG_VERSION_TYPE  = "UNKNOWN";
const char *       ATS_CORE_GIT_COMPONENT_TAG_VERSION_FULL  = "UNKNOWN-dev-f22f4e63-dirty";
const unsigned int ATS_CORE_GIT_VERSION_MAJOR               = 999;
const unsigned int ATS_CORE_GIT_VERSION_MINOR               = 999;
const unsigned int ATS_CORE_GIT_VERSION_PATCH               = 999;
const char *       ATS_CORE_GIT_VERSION_SUFFIX              = "UNKNOWN";
